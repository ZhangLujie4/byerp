...
module.exports = function (models) {
    ...
    router.get('/projectApproval', handler.getOpportunitiesFilters);

    router.get('/workOrders', handler.getWorkOrdersFilters);

    router.get('/orderApproval', handler.getOrderApprovalFilters);

    router.get('/pieceWages', handler.getPieceWagesFilters);

    router.get('/orderReckons', handler.getOrderReckonsFilters);

    router.get('/designRec', handler.getDesignRecFilters);

    router.get('/assign', handler.getAssignFilters);

    router.get('/aluveneerOrders', handler.getAluveneerOrdersFilters);

    router.get('/buildingContract', handler.getBuildingContractFilters);
    router.get('/building', handler.getBuildingFilters);

    router.get('/aluorderApproval', handler.getAluorderApprovalFilters);

    router.get('/fileManagement', handler.getFileManagementFilters);
    router.get('/certificateHistory', handler.getCertificateHistoryFilters);
    router.get('/productBunchType', handler.getProductBunchTypeFilters);
    router.get('/productSurfaceTreat', handler.getProductSurfaceTreatFilters);
    router.get('/engineerInfo', handler.getEngineerInfoFilters);
    router.get('/managementRule', handler.getManagementRuleFilters);
    router.get('/safetyManagement', handler.getSafetyManagementFilters);
    router.get('/productParameter', handler.getProductParameterFilters);
    router.get('/socialInsurance', handler.getSocialInsuranceFilters);
    router.get('/royaltyDetails', handler.getRoyaltyDetailsFilters);
    router.get('/depRoyalty', handler.getDepRoyaltyFilters);
    router.get('/accept', handler.getAcceptFilters);
    router.get('/goodsInNotes', handler.getGoodsInNotesFilters);
    router.get('/produceSchedule', handler.getProduceScheduleFilters);
    router.get('/goodsReturn', handler.getGoodsReturnFilters);
    router.get('/goodsBarcode', handler.getGoodsBarcodeFilters);
    router.get('/goodsScrap', handler.getGoodsScrapFilters);
    router.get('/oemBarcode', handler.getOemBarcodeFilters);
    router.get('/oemNotes', handler.getOemNotesFilters);
    router.get('/timeCard', handler.getTimeCardFilters);
    router.get('/colorNumber', handler.getColorNumberFilters);
    router.get('/shippingNote', handler.getShippingNoteFilters);
    router.get('/shippingPlan', handler.getShippingPlanFilters);
    router.get('/shippingFee',handler.getShippingFeeFilters);
    router.get('/costApportionment',handler.getcostApportionmentFilters);
    router.get('/oemOutNote', handler.getOemOutNoteFilters);
    router.get('/produceMonitoring', handler.getProduceMonitoringFilters);
    return router;
};
