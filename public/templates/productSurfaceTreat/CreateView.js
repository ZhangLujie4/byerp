define([
    ...
    'text!templates/productSurfaceTreat/CreateTemplate.html',
    'models/productSurfaceTreatModel',
    'moment',
    'constants',
    'populate',
    'dataService'
], function ($, _, Backbone, ParentView, CreateTemplate, productSurfaceTreatModel, moment, CONSTANTS, populate, dataService) {

    var CreateView = ParentView.extend({
        el         : '#content-holder',
        contentType: 'productSurfaceTreat',
        ...
        saveItem: function (e) {
            ...
            model = new productSurfaceTreatModel();
            model.urlRoot = function () {
                return 'productSurfaceTreat';
            };
        ...
        render: function (options) {
            ...
            this.$el = $(formString).dialog({
                ...
                title        : 'Create productSurfaceTreat',
                width        : '900px',
                position     : {within: $('#wrapper')},
                buttons      : [
                    {
                        id   : 'create-productSurfaceTreat-dialog',
                        class: 'btn blue',
                        text : '创建',
                        click: function () {
                            self.saveItem();
