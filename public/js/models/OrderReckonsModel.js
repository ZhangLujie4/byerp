define([
    ...
    var OrderReckonsModel = Backbone.Model.extend({
        idAttribute: '_id',
        initialize : function () {
        ...
        parse: function (response) {
            if (response.reckonDate) {
                response.reckonDate = common.utcDateToLocaleDate(response.reckonDate);
            }
            if (response.EndDate) {
        ...
        urlRoot: function () {
            return CONSTANTS.URLS.ORDERRECKONS;
        }
    });
    return OrderReckonsModel;
});
