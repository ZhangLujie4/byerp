define([
    ...
    'views/socialInsurance/ReportView',
    'text!templates/socialInsurance/CreateTemplate.html',
    'models/socialInsuranceModel',
    'moment',
    'constants',
    'populate',
    'dataService'
], function ($, _, Backbone, ParentView, AttachView, ReportView, CreateTemplate, socialInsuranceModel, moment, CONSTANTS, populate, dataService) {
    ...
    var CreateView = ParentView.extend({
        ...
        uploadFile: function (e) {
            ...
            $.ajax({
                url: '/socialInsurance/importFile/'+ datekey,
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(result){
                    ...
                    return new ReportView({model: result});
                    console.log(111);
                },
                error: function(){
                    App.render({
