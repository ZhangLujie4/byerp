define([
    ...
    var EditView = ParentView.extend({
        ...
        render: function () {
            ...
            this.$el.find('#catchPrices').hide();
            this.$el.find('#allocateAll').hide();
            this.$el.find('#unallocateAll').hide();
            this.$el.find('#resetPrices').hide();
            this.$el.find('#selectShippingMethod').hide();
	    this.$el.find('table.tableFixed._invoiceTable.forSCU').hide();
            this.$el.find('#totalAmountContainer').hide();
	    this.$el.find('._statusIndicators').hide();
            this.$el.find('.receiveInvoice').hide();
            // this.$el.find('.pay').hide();
            return this;
        }
