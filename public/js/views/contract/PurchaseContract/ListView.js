define([
    ...
    'Underscore',
    'jQuery',
    'text!templates/contract/PurchaseContract/listTemplate.html',
    'views/contract/PurchaseContract/EditView',
    'views/contract/PurchaseContract/CreateView',
    'models/PurchaseContractModel'
], function (Backbone, _, $, PaymentMethodList, EditView, CreateView,CurrentModel) {
    'use strict';
    ...
    var ContentView = Backbone.View.extend({
        ...
        goToEditDialog: function (e) {
            ...
            model.urlRoot = '/PurchaseContract/';
            model.fetch({
