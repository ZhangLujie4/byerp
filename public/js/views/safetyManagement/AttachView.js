define([
    ...
    'jQuery',
    'Underscore',
    'views/safetyManagement/PdfView',
    'text!templates/safetyManagement/AttachTemplate.html',
    'text!templates/safetyManagement/AttachDocTemplate.html',
    'moment'
], function (Backbone, $, _, PdfView, AttachTemplate, AttachDocTemplate, moment) {
