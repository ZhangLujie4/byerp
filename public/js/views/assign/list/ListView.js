define([
    ...
    'text!templates/assign/list/ListHeader.html',
    'views/assign/CreateView',
    'views/assign/list/ListItemView',
    'views/assign/EditView',
    'models/AssignModel',
    'collections/assign/filterCollection',
    ...
    var AssignListView = ListViewBase.extend({
