define([
    ...
    'text!templates/goodsScrap/UploadTemplate.html',
    'views/dialogViewBase',
    'dataService',
    ...
    var CreateView = ParentView.extend({
        ...
        initialize: function (options) {
            ...
            this.currentModel = new GoodsScrapModel();
            this.responseObj = {};
        ...
        allOpinionUpdate: function () {
            ...
            dataService.patchData('/goodsScrap/', {contentType: this.contentType, ids: this.currentIds, writeOffsId: opinionUrl[3], handlOpinion: handlOpinion}, function (err, response) {
                if (err) {
                    return App.render({
                        type   : 'error',
                        message: '无法处理!'
