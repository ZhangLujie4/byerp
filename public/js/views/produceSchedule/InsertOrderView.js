define([
    ...
    'text!templates/produceSchedule/InsertOrderTemplate.html',
    ...
    'constants'
], function (Backbone, $, _, ParentView, InsertOrderTemplate, produceScheduleModel, common, populate, dataService, AttachView, SelectView, CONSTANTS) {

    var CreateView = ParentView.extend({
        el         : '#content-holder',
        contentType: 'produceSchedule',
        template   : _.template(InsertOrderTemplate),
        responseObj: {},
        ...
        render: function () {
            ...
            dataService.getData('/building/getBuildings', {}, function (buildingContracts) {
                buildingContracts = _.map(buildingContracts.data, function (buildingContract) {
                    buildingContract.name = buildingContract.name;

                    return buildingContract;
                });

                self.responseObj['#projectId'] = buildingContracts;
            });
