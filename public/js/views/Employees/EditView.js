define([
    ...
    var EditView = ParentView.extend({
        ...
        saveItem: function () {
            ...
            gender = $.trim($thisEl.find('#genderDd').attr('data-id'));
            ...
            data = {
                ...
                status: $thisEl.find('#status').val() ? $.trim($thisEl.find('#status').val()) : 0,
                address   : {
            ...
            this.currentModel.save(this.currentModel.data, {
                headers: {
                    mid: 39
                },
                wait   : true,
        ...
        render: function () {
            ...
            common.getWorkflowContractEnd('Applications', null, null, CONSTANTS.URLS.WORKFLOWS, null, '合同到期', function (workflow) {
          ...
          /*  $thisEl.find('.date').datepicker({
           ...
           // console.log("currentModel",currentModel);
            ...
            this.$el.find('#address').distpicker({
                    province: this.currentModel.toJSON().address.province,
                    city: this.currentModel.toJSON().address.city,
                    district: this.currentModel.toJSON().address.district,
