define([
    ...
    'Underscore',
    'views/listViewBase',
    'text!templates/shippingNote/list/ListHeader.html',
    'views/shippingNote/list/ListItemView',
    'views/shippingNote/EditView',
    'constants',
    'populate',
    'moment',
    'custom'
    ...
    var workPointListView = ListViewBase.extend({
        ...
        EditView    : EditView,
        contentType : CONSTANTS.SHIPPINGNOTE,
        formUrl     : '#easyErp/shippingNote/form/',
        ...
        initialize: function (options) {
            ...
            dateRange = custom.retriveFromCash('shippingNoteDateRange');
            this.filter = options.filter || custom.retriveFromCash('shippingNote.filter');
            if (!this.filter) {
                this.filter = {};
            }
            ...
            custom.cacheToApp('shippingNote.filter', this.filter);
        },
