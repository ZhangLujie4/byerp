define([
    ...
    'text!templates/addValueTaxInvoice/list/ListHeader.html',
    'text!templates/stages.html',
    'views/addValueTaxInvoice/CreateView',
    'views/addValueTaxInvoice/list/ListItemView',
    'views/addValueTaxInvoice/EditView',
    'models/acceptModel',
    ...
    var TasksListView = ListViewBase.extend({
        ...
        goToEditDialog: function (e) {
            ...
            model.urlRoot = '/addValueTaxInvoice/';
            model.fetch({
