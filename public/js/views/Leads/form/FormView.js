define([
    ...
    var FormOpportunitiesView = Backbone.View.extend({
        ...
        render: function () {
            ...
            $thisEl.find('#bidDate').datepicker({
                dateFormat : 'yy-MM-dd',
                changeMonth: true,
                changeYear : true,
                monthNames: ['01','02','03','04','05','06', '07','08','09','10','11','12'],
                ...
                dayNamesMin: ['日','一','二','三','四','五','六'], 
                onSelect   : function (dateText) {
                    self.modelChanged['leadDate.bidDate'] = new Date(dateText);
                    $(this).closest('.propertyFormList').addClass('active');
                    self.showButtons();
                }
            ...
            $thisEl.find('#bidbailDate').datepicker({
                dateFormat : 'yy-MM-dd',
                changeMonth: true,
                changeYear : true,
                monthNames: ['01','02','03','04','05','06', '07','08','09','10','11','12'],
                ...
                dayNamesMin: ['日','一','二','三','四','五','六'], 
                onSelect   : function (dateText) {
                    self.modelChanged['leadDate.bidbailDate'] = new Date(dateText);
                    $(this).closest('.propertyFormList').addClass('active');
                    self.showButtons();
                }
            ...
            dataService.getData('/departments/getForDD', {}, function (departments) {
                departments = _.map(departments.data, function (department) {
                    department.name = department.name;

                    return department;
                });
                self.responseObj['#regDepart'] = departments;
            });
