define([
    ...
    'text!templates/chargeItems/list/ListHeader.html',
    'views/chargeItems/CreateView',
    'views/chargeItems/list/ListItemView',
    'views/chargeItems/EditView',
    'models/ChargeItemsModel',
    'collections/chargeItems/filterCollection',
    ...
    var ChargeItemsListView = ListViewBase.extend({
