define([
    ...
    'Backbone',
    'views/listViewBase',
    'views/settingsOverview/settingsEmployee/missionAllowance/CreateView',
    'views/settingsOverview/settingsEmployee/missionAllowance/EditView',
    'views/settingsOverview/settingsEmployee/missionAllowance/list/ListItemView',
    'text!templates/settingsOverview/settingsEmployee/missionAllowance/list/ListHeader.html',
    ...
    var missionAllowanceListView = ListViewBase.extend({
        el               : '#missionAllowance',
    ...
    return missionAllowanceListView;
});
