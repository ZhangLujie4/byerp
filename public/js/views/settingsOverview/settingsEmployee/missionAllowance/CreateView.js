define([
    ...
    'text!templates/settingsOverview/settingsEmployee/missionAllowance/CreateTemplate.html',
    'models/missionAllowanceModel',
    'moment',
    'constants',
    'populate',
    'dataService'
], function ($, _, Backbone, ParentView, CreateTemplate, missionAllowanceModel, moment, CONSTANTS, populate, dataService) {
    ...
    var CreateView = ParentView.extend({
        ...
        saveItem: function (e) {
            ...
            model = new missionAllowanceModel();
