define([
    ...
    var ContentView = Backbone.View.extend({
        ...
        createItemListRow: function (item, index, className) {
            ...
            var str = '<li class="' + className + disabled + '" data-id="' + item._id + '" data-level="' + item.nestingLevel + '" data-sequence="' + item.sequence + '"><span class="content"><span class="dotted-line"></span><span class="text">' + item.name + '<span title="编辑" class="editCategoryItem edit icon-pencil"></span>';

            if (item.removable){
              str += '<span title="删除" class="deleteCategoryItem trash icon-trash"></span></span></span></li>'
            } else {
              str += '</span></span></li>'
            }
