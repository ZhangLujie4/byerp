define([
    'Backbone',
    'Underscore',
    'text!templates/settingsOverview/settingsEmployee/tax/list/ListTemplate.html'
], function (Backbone, _, listTemplate) {
    'use strict';

    var TaxListItemView = Backbone.View.extend({
        el: '#listTable',
