define([
    ...
    'text!templates/orderReckons/list/ListHeader.html',
    'views/orderReckons/CreateView',
    'views/orderReckons/list/ListItemView',
    'views/orderReckons/EditView',
    'models/OrderReckonsModel',
    'collections/orderReckons/filterCollection',
    ...
    var OrderReckonsListView = ListViewBase.extend({
