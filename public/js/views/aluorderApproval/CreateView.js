define([
    ...
    'text!templates/aluorderApproval/CreateTemplate.html',
    ...
    'constants'
], function (Backbone, $, _, ParentView, CreateTemplate, AluorderApprovalModel, common, populate, dataService, AttachView, SelectView, CONSTANTS) {
    ...
    var CreateView = ParentView.extend({
        ...
        initialize: function () {
            ...
            this.model = new AluorderApprovalModel();
