define([
    ...
    'text!templates/workOrders/list/ListHeader.html',
    'views/workOrders/CreateView',
    'views/workOrders/list/ListItemView',
    'views/workOrders/EditView',
    'models/WorkOrdersModel',
    'collections/workOrders/filterCollection',
    ...
    var WorkOrdersListView = ListViewBase.extend({
