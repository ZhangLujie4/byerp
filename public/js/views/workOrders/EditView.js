define([
    ...
    'text!templates/workOrders/EditTemplate.html',
    'text!templates/workOrders/chargeItemEdit.html',
    'text!templates/workOrders/processContentEdit.html',
    ...
    var EditView = ParentView.extend({
        ...
        initialize: function (options) {
            ...
            this.currentModel.urlRoot = CONSTANTS.URLS.WORKORDERS;
        ...
        saveItem: function (event) {
            ...
            var operatorNumber = $.trim($currentEl.find('#operatorNumber').val());
            ...
            for (var i = 0; i < chargeLength ; i++) {
                ...
                var chargeId = targetEl1.find('[data-name="chargeIds"] input').val();
            ...
            for (var i = 0; i < processLength ; i++) {
                ...
                var processId = targetEl2.find('[data-name="processIds"] input').val();
