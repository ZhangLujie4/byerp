define([
    ...
    'helpers',
    'views/ExpensesInvoice/CreatePayment'
], function ($, _, listViewBase, listTemplate, CreateView, EditView, InvoiceModel, ListItemView, contentCollection, helpers,CreatePayment) {
    'use strict';
    ...
    var InvoiceListView = listViewBase.extend({
        ...
        events: {
            'click  #createPayment'                                             : 'createPayment'
