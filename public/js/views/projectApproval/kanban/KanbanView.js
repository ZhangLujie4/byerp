define([
    ...
    'Underscore',
    'jQuery',
    'text!templates/projectApproval/kanban/WorkflowsTemplate.html',
    'text!templates/projectApproval/kanbanSettings.html',
    'collections/Workflows/WorkflowsCollection',
    'views/projectApproval/kanban/KanbanItemView',
    'views/projectApproval/EditView',
    'views/projectApproval/CreateView',
    'collections/projectApproval/OpportunitiesCollection',
    'models/OpportunitiesModel',
    'dataService',
    'views/Filter/filterView',
    'views/selectView/selectView',
    'collections/projectApproval/filterCollection',
    'constants',
    'helpers',
    'views/pagination',
    'custom',
    ...
    var OpportunitiesKanbanView = Pagination.extend({
        ...
        render: function () {
            ...
            console.log(this.workflowsCollection.toJSON());
