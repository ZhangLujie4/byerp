define([
    ...
    'text!templates/projectApproval/EditTemplate.html',
    'text!templates/projectApproval/editSelectTemplate.html',
    ...
    var EditView = ParentView.extend({
        ...
        saveItem: function () {
            ...
            var archPersonId = this.$el.find('#archPersonDd').data('id') || null;
            var currentSalesPerson = this.currentModel.get('salesPerson');
            var currentArchPerson = this.currentModel.get('archPerson');
