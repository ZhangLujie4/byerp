define([
    ...
    var View = Backbone.View.extend({
        ...
        renderQuantityTable: function (response) {
            var $svg = this.$el.closest(this.id);
            var data = response.data;
            var columns = [{
                text    : '供应商',
            ...
            chartObj = {
                ...
                table: {
                    ...
                    purchaseQtyTable: function () {
                        ...
                        common.getGoodsInNotes(filter, false, function (data) {
                            self.renderQuantityTable(data, '_id');
                        });

                        self.setHref('goodsInNotes');
                    }
                }
            };
