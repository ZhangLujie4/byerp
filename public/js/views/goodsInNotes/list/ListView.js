define([
    ...
    'Underscore',
    'views/listViewBase',
    'text!templates/goodsInNotes/list/ListHeader.html',
    'views/goodsInNotes/list/ListItemView',
    'collections/goodsInNotes/filterCollection',
    ...
    var PaymentListView = ListViewBase.extend({
        ...
        contentType      : 'goodsInNotes', // needs in view.prototype.changeLocationHash
        modelId          : null,
        $listTable       : null,
        editCollection   : null,
