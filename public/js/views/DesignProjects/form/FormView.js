define([
    ...
    'jQuery',
    'Underscore',
    'text!templates/DesignProjects/form/FormTemplate.html',
    ...
    var View = Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            this.formModel.urlRoot = '/DesignProjects/';
            this.type=this.formModel.toJSON().designContractType._id;
            this.responseObj = {};
            ...
            if(this.type=='WBSJHT'||this.type=='XMBSJHT'){
        ...
        saveItem: function () {
            ...
            var self = this;
            var mid = 39;
            var name = $thisEl.find('#projectName').attr('data-id')||null;
           ...
           /* var accountReceivable= $.trim(this.$el.find('#accountReceivable').val());
            ...
            var archiveMan = $thisEl.find('#archiveMan').data('id')||null;
           /* var door;
            var wall;
            var other;
            var requireType=[];
            ...
            if(designContractType=='WBSJHT'||designContractType=='XMBSJHT'){
                data={
        ...
        deleteItems: function () {
            ...
            this.formModel.destroy({
                ...
                success: function () {
                    Backbone.history.navigate('#easyErp/DesignProjects/thumbnails', {trigger: true});
                }
            });}
