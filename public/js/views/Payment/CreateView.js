    ...
    var CreateView = Parent.extend({
        ...
        render: function () {
            ...
            if (!model.paymentMethod && model.project && model.project.paymentMethod) {
                populate.get('#paymentMethod', '/paymentMethod', {}, 'name', this, false, true, model.project.paymentMethod, null);
            } else {
                populate.get('#paymentMethod', '/paymentMethod', {}, 'name', this, false, true, model.paymentMethod, null, this.$el);
            }
