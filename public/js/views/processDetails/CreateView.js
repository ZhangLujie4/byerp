define([
    ...
    'text!templates/processDetails/CreateTemplate.html',
    ...
    'constants'
], function (Backbone, $, _, ParentView, CreateTemplate, ProcessDetailsModel, common, populate, AttachView, SelectView, CONSTANTS) {
