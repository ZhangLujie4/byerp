define([
    ...
    'text!templates/orderApproval/CreateTemplate.html',
    ...
    'constants'
], function (Backbone, $, _, ParentView, CreateTemplate, OrderApprovalModel, common, populate, dataService, AttachView, SelectView, CONSTANTS) {
    ...
    var CreateView = ParentView.extend({
        ...
        initialize: function () {
            ...
            this.model = new OrderApprovalModel();
