define([
    ...
    'text!templates/productSurfaceTreat/EditTemplate.html',
    'populate',
    'constants',
    'helpers',
    'moment',
    ...
    var EditView = ParentView.extend({
        ...
        initialize: function (options) {
            ...
            this.currentModel.urlRoot = '/productSurfaceTreat';
        ...
        hideDialog: function () {
            $('.edit-productSurfaceTreat-dialog').remove();
        },
        ...
        render: function () {
            ...
            this.$el = $(formString).dialog({
                ...
                autoOpen     : true,
                resizable    : true,
                dialogClass  : 'edit-productSurfaceTreat-dialog',
                title        : 'Edit productSurfaceTreat',
