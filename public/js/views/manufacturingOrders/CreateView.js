...
], function (Backbone, _, $, Parent, ProductItemView, Model, ProductCollection, CreateTemplate, ConsumedTemplate, CONSTANTS, dataService, populate, helpers, keyValidator) {
    'use strict';
