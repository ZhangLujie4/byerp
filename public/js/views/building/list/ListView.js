define([
    ...
    'text!templates/building/list/ListHeader.html',
    'views/building/CreateView',
    'views/building/list/ListItemView',
    'views/building/EditView',
    'models/buildingModel',
    'collections/building/filterCollection',
    ...
    var BuildingListView = ListViewBase.extend({
