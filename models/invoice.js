module.exports = (function () {
    ...
    var addedValueTaxInvoiceSchema=baseSchema.extend({
        ...
        realAmount     :{type:Number,default:null},
    ...
    addedValueTaxInvoiceSchema.set('toJSON', {getters: true});
    mongoose.model('addedValueTaxInvoice', addedValueTaxInvoiceSchema);
    mongoose.Schemas.addValueTaxInvoice = addedValueTaxInvoiceSchema;
})();
