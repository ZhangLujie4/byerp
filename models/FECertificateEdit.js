module.exports = (function () {
    ...
    var FECertificateEditSchema = mongoose.Schema({
    ...
    }, {collection: 'FECertificateEdit'});

    mongoose.model('FECertificateEdit', FECertificateEditSchema);

    if (!mongoose.Schemas) {
        mongoose.Schemas = {};
    }

    mongoose.Schemas.FECertificateEdit = FECertificateEditSchema;
})();
