module.exports = (function () {
    ...
    var projectSchema = mongoose.Schema({
        ...
        lssArea         : {type: String, default:null},
        signedDate      : Date,
        archDate        : Date,
        ...
        preAmount       : {type: String, default:null},
        payTerms        : {type: String, default:null},
        settlementTerms : {type: String, default:null},
        response        : String,
        violation       : String,
        quality         : String,
        archiveMan      : {type: ObjectId, ref: 'Employees',default: null},
        lead            : {type: ObjectId, ref: 'Opportunities', default: null},
        groups: {
