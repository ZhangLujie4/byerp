module.exports = (function () {
    ...
    var opportunitiesSchema = mongoose.Schema({
        ...
        isComproject   : {type: Boolean, default: false},
        regDepart      : {type: ObjectId, ref: 'Department', default: null},
        proManager     : {type: String, default: ''},
        transactor     : {type: String, default: ''},
        ...
        archPerson  : {type: ObjectId, ref: 'Employees', default: null},
        archNumber  : {type: Number, default: 0},
        prjAmount   : {type: Number, default: 0},
        prjCost     : {type: Number, default: 0},
        prjQuota    : {type: Number, default: 0},
        bidCost     : {type: Number, default: 0},
        enrollCost  : {type: Number, default: 0},

        quoPerson   : {type: String, default: ''},
        busPerson   : {type: String, default: ''},
        expDepart   : {type: String, default: ''},
        otherDetail : {type: String, default: ''},

        taxDesc     : {type: String, default: ''},
        bailType    : {type: String, default: ''},
        bail        : {type: Number, default: 0},
        fieldDesc   : {type: String, default: ''},
        genUnit     : {type: String, default: ''},
        genDesc     : {type: String, default: ''},
        openState   : {type: String, default: ''},
        sealState   : {type: String, default: ''},
        bidFils     : {type: String, default: ''},

        entReq      : {type: String, default: ''},
        levelReq    : {type: String, default: ''},
        pmReq       : {type: String, default: ''},

        archerDate: {
            winDate  : {type: Date, default: null},
            archDate : {type: Date, default: null}
        },

        leadDate: {
            bidDate     : {type: Date, default: null}, 
            bidbailDate : {type: Date, default: null}, 
            retDate     : {type: Date, default: null},  
            questionDate: {type: Date, default: null}   
        },

        biderDate   : {type: Date, default: null},  
        openDate    : {type: Date, default: null}, 

        questions   : {type: String, default: ''}, 

        bidDepartment   : {type: String, default: ''},

        projectDesc: {
            pD1:  {type: String, default: ''},
            pD2:  {type: String, default: ''},
            pD3:  {type: String, default: ''},
            pD4:  {type: String, default: ''},
            pD5:  {type: Number, default: 0}
        ...
        inforDesc: {
            ...
            pD3:  {type: String, default: ''},
            pD4:  {type: String, default: ''},
            pD5:  {type: String, default: ''},
            pD6:  {type: String, default: ''}
